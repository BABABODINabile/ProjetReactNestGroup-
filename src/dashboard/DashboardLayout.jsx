...
import { FaHome, FaFolderOpen, FaExchangeAlt, FaUser, FaUsers, FaSignOutAlt, FaBell, FaCog, FaChevronDown, FaBars, FaTimes, FaWallet } from 'react-icons/fa';
...
export default function DashboardLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      {/* SIDEBAR */}
      <aside className={`${sidebarOpen ? "w-64" : "w-20"} bg-white shadow-2xl transition-all duration-300 flex flex-col border-r border-gray-200  overflow-hidden`}>
        {/* Logo Section */}
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <div className={`flex items-center gap-3 ${!sidebarOpen && "justify-center"}`}>

              {sidebarOpen &&<div className="w-12 h-12 bg-gradient-to-br from-blue-600 to-blue-700 rounded-lg flex items-center justify-center shadow-lg">
                <FaWallet className="text-white font-bold text-center" size={30}/>
              </div>}
              {sidebarOpen && (
                <div>
      ...
      {/* MAIN CONTENT */}
      <div className="flex-1 flex flex-col gap-3 m-3 mt-0 mr-0">
        {/* TOP HEADER */}
        <header className="bg-white shadow-xl  border border-gray-200">
          <div className="px-8 py-5 flex items-center justify-between">
            {/* Left - Search Bar */}
            <div className="flex-1">
              <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-blue-700 bg-clip-text text-transparent hover:bg-gradient-to-r hover:from-red-500 hover:to-blue-900">
                Système gestion des dépenses et recettes
              </h1>
            </div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <div className="hidden sm:block text-left">
                    ...
                    <p className="text-xs text-gray-500">{user.firstname+" "+user.name}</p>
                  </div>
        ...
        {/* PAGE CONTENT */}
        <main className="flex-1 p-8 overflow-auto bg-white shadow-lg border border-gray-200">
          <Outlet />
        </main>
      </div>
    </div>
